...
public class ShowImageActivity extends RoboSherlockFragmentActivity {
	...
	private void performRequest() {
		contentManager.execute(clusteredImagesRequest, new ListImagesRequestListener());
	}
	...
	private class ListImagesRequestListener implements RequestListener<ImageList> {
		...
		public void onRequestSuccess(ImageList imageList) {
			...
			for (int i = 0; i < showImageListAdapter.getCount(); i++) {
				View showImageItemView = showImageListAdapter.getView(i, null, ShowImageActivity.this.linearView);
